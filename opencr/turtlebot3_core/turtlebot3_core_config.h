...
void startServoPositionCallback(const std_msgs::Bool& start_servo_msg);
void leftRightCallback(const std_msgs::Bool& left_right_msg);
void btiCallback(const std_msgs::Bool& bti_msg);
...
/*******************************************************************************
* Declaration for Pan Tilt Servo
*******************************************************************************/
Servo leftRightServo;
int32_t left_right_angle;
int32_t temp_lr;
std_msgs::Int32 angle_msg;
ros::Publisher angle_pub("angle", &angle_msg);
//std_msgs::Bool start_servo_msg;
ros::Subscriber<std_msgs::Bool> start_servo_sub("start_servo_position", startServoPositionCallback);
ros::Subscriber<std_msgs::Bool> left_right_sub("left_right_servo", leftRightCallback);

/*******************************************************************************
* Declaration for Bti Servo
*******************************************************************************/
Servo btiServo;
bool bti_deploy;
ros::Subscriber<std_msgs::Bool> bti_sub("/imagenet/bti_servo", btiCallback);
int true_count;
int deployed;
